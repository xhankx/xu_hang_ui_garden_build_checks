...
import fse, { readFile, writeFile, createWriteStream, move, remove, pathExistsSync } from 'fs-extra';
...
export { HandledError, JsPackageManager, JsPackageManagerFactory, __require, codeLog, commandLog, copyTemplate, copyTemplateFiles, createLogStream, externalFrameworks, getBabelDependencies, getBowerJson, getCliDir, getEnvConfig, getPackageDetails, getStorybookVersionSpecifier, installableProjectTypes, isNxProject, paddedLog, parseList, supportedTemplates, unsupportedTemplate, useNpmWarning, versions_default };
